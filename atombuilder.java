...
//when saying atom name, say "atomname" + # of protons + neutrons (to account for isotopes), could just be infinitely scalable
...
But with less data per atom and a rudimentary gui display + an atom creator 
*/